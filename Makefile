...
test: ## Run tests
	...
	GOTOOLCHAIN=go1.27.1+auto go test -coverprofile=/tmp/artifacts/cover.out ./...
...
build: go-gen fmt vet ## Build publisher binary.
	GOTOOLCHAIN=go1.27.1+auto go build -o bin/publisher cmd/eventing-publisher-proxy/main.go
