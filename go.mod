...
require (
	...
	github.com/kyma-project/eventing-manager v0.0.0-20250528133021-e51b68a8e70c
...
require (
	...
	github.com/kyma-project/kyma/common/logging v0.0.0-20250214133221-d56fb413445a // indirect
