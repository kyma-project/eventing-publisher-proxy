...
require (
	...
	github.com/kyma-project/eventing-manager v0.0.0-20240716135437-f70004eaac74
...
require (
	...
	github.com/kyma-project/kyma/common/logging v0.0.0-20240715064935-3ba0407c904e // indirect
